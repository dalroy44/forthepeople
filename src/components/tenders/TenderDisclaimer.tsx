  ...
  return (
    ...
    >
      ...
      <ol style={{ paddingLeft: 18, margin: 0 }}>
        ...
        <li style={{ marginBottom: 8 }}><strong>Takedown & grievance.</strong> 7-working-day SLA. Email <a href="mailto:takedown@forthepeople.in" style={{ color: "#2563EB", textDecoration: "underline" }}>takedown@forthepeople.in</a>. Winning bidders may request 7-year anonymisation for individual records.</li>
